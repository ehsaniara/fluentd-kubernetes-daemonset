...
IMAGE_NAME := ehsaniara/fluentd-kubernetes-daemonset
ALL_IMAGES := \
	v1.9/debian-elasticsearch7:v1.9.2-debian-elasticsearch7-1.0,v1.9-debian-elasticsearch7-1,v1-debian-elasticsearch \
	v1.9/debian-elasticsearch6:v1.9.2-debian-elasticsearch6-1.0,v1.9-debian-elasticsearch6-1 \
	v1.9/debian-loggly:v1.9.2-debian-loggly-1.0,v1.9-debian-loggly-1 \
	v1.9/debian-logentries:v1.9.2-debian-logentries-1.0,v1.9-debian-logentries-1 \
	v1.9/debian-cloudwatch:v1.9.2-debian-cloudwatch-1.0,v1.9-debian-cloudwatch-1 \
	v1.9/debian-stackdriver:v1.9.2-debian-stackdriver-1.0,v1.9-debian-stackdriver-1 \
	v1.9/debian-s3:v1.9.2-debian-s3-1.0,v1.9-debian-s3-1 \
	v1.9/debian-syslog:v1.9.2-debian-syslog-1.0,v1.9-debian-syslog-1 \
	v1.9/debian-forward:v1.9.2-debian-forward-1.0,v1.9-debian-forward-1 \
	v1.9/debian-gcs:v1.9.2-debian-gcs-1.0,v1.9-debian-gcs-1 \
	v1.9/debian-graylog:v1.9.2-debian-graylog-1.0,v1.9-debian-graylog-1 \
	v1.9/debian-papertrail:v1.9.2-debian-papertrail-1.0,v1.9-debian-papertrail-1 \
	v1.9/debian-logzio:v1.9.2-debian-logzio-1.0,v1.9-debian-logzio-1 \
	v1.9/debian-kafka:v1.9.2-debian-kafka-1.0,v1.9-debian-kafka-2 \
	v1.9/debian-kinesis:v1.9.2-debian-kinesis-1.0,v1.9-debian-kinesis-1
